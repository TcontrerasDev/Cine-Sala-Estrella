...
function js_functions(){
    ...
    if(!is_admin()) {
        ...
        wp_register_script('cartelera', get_bloginfo('template_directory') . '/assets/librerias/js/cartelera.js', array(), '1.0', true);
        ...
        wp_localize_script('cartelera', 'Peliculas', array(
            'peliculasurl' => esc_url(rest_url('wp/v2/')),
            'nonce' => wp_create_nonce('peliculas-nonce'),
        ));
